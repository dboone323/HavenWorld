 ...
 * Shared module for client and server.
 */
...
export function findPath(
  ...
  // If target tile is blocked, pick the closest unblocked adjacent neighbor
  ...
  // No path found, return direct target as fallback
  return [{ x: targetX, y: targetY }];
}
