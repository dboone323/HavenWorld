...
## Phase 0: Foundation (macOS dev environment) — IN PROGRESS
...
- [ ] 0.5 TypeScript migration of shared modules + server + typed protocol
- [ ] 0.6 Directory restructure: src/client/ + src/shared/types/

## Phase 3: Native Packaging (macOS/iOS) — PENDING
...
- Commit b80b6ce pushed to origin/main
