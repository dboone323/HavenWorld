...
set -uo pipefail
cd /Users/danielstevens/Developer/HavenWorld/apps/server
...
if ! start_server 3222 "$TEST_URL" /tmp/hw_probe1.log; then
  echo "SERVER FAILED TO START"; tail -20 /tmp/hw_probe1.log; exit 1
fi
echo "server up."
