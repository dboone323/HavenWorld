...
NODE_ENV=test SERVER_AUTOSTART=true ALPHA_INVITE_ONLY=false PORT=3224 DATABASE_URL="$TEST_URL" \
  REDIS_URL="redis://127.0.0.1:6379/1" nohup pnpm exec tsx src/index.ts > /tmp/hw_gate.log 2>&1 &
